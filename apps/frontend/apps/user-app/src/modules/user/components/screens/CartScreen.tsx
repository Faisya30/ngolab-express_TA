      ...
      <div className="w-full h-full min-h-screen bg-[#fbf7f2] text-slate-950 overflow-hidden">
         <header className="h-[72px] px-7 flex items-center justify-between bg-[#fbf7f2]">
            <div className="flex items-center gap-4">
               <button
                  onClick={onBack}
                  className="flex items-center gap-2 bg-white rounded-full px-4 py-2 shadow-sm border border-orange-50 active:scale-95 transition"
               >
         ...
         <main className="h-[calc(100vh-72px)] flex overflow-hidden px-6 pb-6 gap-6">
            <section className="flex-1 overflow-y-auto no-scrollbar pr-1">
               <div className="space-y-5">
                           ...
                           {cart.map((item) => (
                              <div key={item.id} className="flex items-center gap-4">
                                 ...
                                 <div className="flex-1 min-w-0">
                                    <h3 className="text-[13px] font-black uppercase truncate">{item.name}</h3>
                                    ...
                                    <div className="mt-3 flex items-center gap-2">
                                       <button
                                          ...
                                          className="w-7 h-7 rounded-full bg-slate-100 font-black"
                                       >
                                          -
                                       </button>
                                       ...
                                       <button
                                          onClick={() => onUpdateQty(item.id, 1)}
                                          className="w-7 h-7 rounded-full bg-[#07111f] text-white font-black"
                                       >
                                          +
                                       </button>
                                    </div>
                                    ...
                                    <textarea
                                       ...
                                       className="mt-3 w-full bg-slate-50 rounded-xl px-3 py-2 text-[10px] text-slate-700 placeholder:text-slate-300 outline-none resize-none border border-transparent focus:border-orange-300 focus:bg-white transition"
                                       rows={2}
                                 ...
                                 <div className="text-right">
                                    ...
                                    <button
                                       ...
                                       className="mt-4 w-8 h-8 rounded-full bg-slate-50 text-slate-400 hover:text-red-500 transition"
                                    >
                                       🗑
                                    </button>
                                 </div>
                     ...
                     <div className="bg-white rounded-3xl p-6 shadow-sm border border-orange-50">
                        ...
                        <div className="mt-5 flex items-center justify-between">
                           ...
                           <button
                              ...
                              className={`w-12 h-7 rounded-full relative transition ${useKoin ? 'bg-orange-500' : 'bg-slate-200'
                                 }`}
                           >
                              <span
                                 className={`absolute top-1 w-5 h-5 bg-white rounded-full transition ${useKoin ? 'right-1' : 'left-1'
                                    }`}
                              />
                           </button>
                        </div>
                     ...
                     <div className="bg-white rounded-3xl p-6 shadow-sm border border-orange-50">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                           <button
                              ...
                              className={`h-[96px] rounded-2xl border-2 flex flex-col items-center justify-center gap-2 relative transition ${selectedMethod === PaymentMethod.QRIS
                           ...
                           <button
                              ...
                              className={`h-[96px] rounded-2xl border-2 flex flex-col items-center justify-center gap-2 transition ${selectedMethod === PaymentMethod.CASH
                                    ? 'border-orange-500 bg-orange-50 text-orange-500'
                                    : 'border-slate-100 bg-white text-slate-300'
                                 }`}
                           >
                  ...
                  <div className="bg-white rounded-3xl p-5 shadow-sm border border-orange-50 flex items-center justify-between">
                     <div className="flex items-center gap-4">
            ...
            <aside className="w-[360px] bg-white rounded-3xl shadow-sm border border-orange-50 flex flex-col overflow-hidden">
               <div className="p-7 border-b border-orange-50">
                  ...
                  {member ? (
                     <button
                        ...
                        className="w-full bg-orange-50 border border-orange-100 rounded-2xl p-4 text-left"
                     >
                     ...
                     <div className="bg-orange-50 rounded-2xl p-4 border border-orange-100">
                        ...
                        <button
                           ...
                           className="mt-4 w-full rounded-full border border-orange-400 text-orange-500 py-3 font-black text-[10px] uppercase tracking-widest"
                        >
                           Login Member
                        </button>
                     </div>
               ...
               <div className="p-7">
                  <button
                     ...
                     className={`w-full rounded-2xl py-5 px-6 flex items-center justify-between uppercase font-black tracking-widest transition ${cart.length > 0
