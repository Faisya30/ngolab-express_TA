...
import backgroundWelcome from '../../../../shared/assets/images/background-welcomescreen.png';
import HandIcon from '@iconify-react/pixelarticons/hand';
import GiftIcon from '@iconify-react/pixelarticons/gift';
    ...
    <div className="absolute inset-0 z-0">
      ...
      <header className="relative z-20 px-8 pt-6 flex items-start justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div
            className={`border backdrop-blur-xl rounded-2xl px-5 py-3 flex items-center gap-3 transition-all ${handTrackingEnabled
      ...
      <main className="relative z-20 h-[calc(100vh-100px)] px-20 flex flex-col justify-center pb-36">
      ...
      <section className="absolute bottom-14 left-8 right-8 z-30 bg-white/7 border border-white/10 backdrop-blur-2xl rounded-3xl p-5 grid grid-cols-3 gap-5 shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
        {[
          ...
          [
            <HandIcon height="34" />,
            handTrackingEnabled ? 'Gesture Aktif' : 'Aktifkan Gesture',
            'Navigasi tanpa sentuh dengan gerakan tangan',
          ],
          [
            <GiftIcon height="34" />,
            'Pakai Voucher',
            'Gunakan voucher untuk harga lebih hemat',
          ],
        ].map((item, index) => {
