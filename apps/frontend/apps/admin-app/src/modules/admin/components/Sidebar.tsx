    ...
    <aside className="fixed inset-y-0 left-0 z-30 flex w-64 shrink-0 flex-col overflow-hidden border-r border-slate-800/70 bg-[#071123] shadow-2xl">
      ...
      <div className="relative z-10 flex shrink-0 items-center gap-3 px-6 pb-7 pt-7">
        ...
        <div className="min-w-0">
          <h1 className="text-[15px] font-black leading-tight tracking-tight text-white">
            NGOLAB
          </h1>
      ...
      <div className="relative z-10 shrink-0 p-4">
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 shadow-inner">
          ...
          <button
            onClick={onLogout}
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-600 bg-slate-800/80 py-3 text-[10px] font-black uppercase tracking-wider text-slate-300 transition-all duration-300 hover:border-rose-500/60 hover:bg-rose-500/20 hover:text-rose-300 active:scale-95"
          >
